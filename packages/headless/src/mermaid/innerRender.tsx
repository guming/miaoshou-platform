import { type Editor, type NodeViewRendererProps, mergeAttributes } from "@tiptap/core";
...
export class InnerRenderView implements NodeView {
  ...
  public static create(
    options: Partial<Omit<InnerRenderViewOptions, keyof Omit<NodeViewRendererProps, "HTMLAttributes">>>,
  ) {
