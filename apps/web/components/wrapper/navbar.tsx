...
import { Github, Menu, Twitter, WandSparkles, Youtube } from "lucide-react";
      ...
      <div className="flex items-center justify-between p-4 max-w-7xl mx-auto">
            ...
            <SheetContent side="left" className="w-[300px]">
              ...
              <div className="flex flex-col gap-1 mt-6">
                ...
                <div className="px-2 py-4 border-t">
                  ...
                  <Link href="https://twitter.com/guming" target="_blank" prefetch={true}>
                    <Button
                      variant="ghost"
                      className="w-full justify-start text-base font-normal h-11 border border-muted/40 mb-2 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-950/50 dark:hover:text-blue-400 transition-colors"
                    >
                  ...
                  <Link href="https://youtube.com/@rasmickyy" target="_blank" prefetch={true}>
                    <Button
                      variant="ghost"
                ...
                {!userId && (
                  <div className="px-2 py-4 border-t mt-auto">
                    <Link href="/sign-in" prefetch={true}>
                      <Button className="w-full bg-blue-600 hover:bg-blue-500">Sign in</Button>
                    </Link>
                  </div>
                )}
              </div>
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <Link href="/editor" prefetch={true}>
            <Button variant="ghost">Miao Editor</Button>
          </Link>
