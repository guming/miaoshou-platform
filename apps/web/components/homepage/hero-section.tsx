...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-center py-20" aria-label="Nextjs Starter Kit Hero">
      {/* Background gradient */}
      ...
      <div className="space-y-6 text-center max-w-4xl px-4">
        ...
        >
          Fast Stem notes with <br className="hidden sm:block" />
          Miao Editor.
        </motion.h1>
        ...
        >
          Miao Editor is the text editor for anyone in STEM. Try it for yourself..
        </motion.p>
